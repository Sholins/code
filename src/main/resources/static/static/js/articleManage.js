layui.use('table', function(){
    ...
    var tableIns = table.render({
        ...
        ,title: '资源数据表'
        ,cols: [[
            {field:'name', title:'资源名称', width:236, fixed: 'left',templet: "#nameTpl"}
            ,{field:'email', title:'所属类别', width:130, templet: "#arcTypeTpl"}
            ,{field:'points', title:'积分', width:90, sort: true, templet: "#pointsTpl"}
            ,{field:'publishDate', title:'发布日期', width:180, sort: true}
            ,{field:'state', title:'审核状态', width:110, templet: "#stateTpl"}
